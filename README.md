...
<br/><br/>
	...
	* 단서 3 *
	...
	C-1 횟수로 만들 수 없다.
증명
* C 횟수로 만들 수 있는 카드의 배치는 C-1 횟수로 만들 수 있는 카드의 배치에서 한 번의 교환으로 만들 수 있어야한다. 1회로 만들 수 있는 카드의 배치는 0회로 만들 수 없다는 것을 안다면 어떤 C 횟수로 만들 수  있는 카드의 배치가 어떤 C-1 횟수로 만들 수 있게되는순간 모든 횟수에서 모든 카드의 배치를 만들 수 있게 된다 따라서 공리에 위배되므로 거짓이다.
